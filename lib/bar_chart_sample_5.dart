...
class BarChartSample5State extends State<BarChartSample5> {
  ...
  static const List<List<double>> piecemealBarValues = [
    [2, 3, 2.5, 8],
    [-1.8, -2.7, -3, -6.5],
    [1.5, 2, 3.5, 6],
    [1.5, 1.5, 4, 6.5],
  ...
  Widget bottomTitles(double value, TitleMeta meta) {
    ...
    switch (value.toInt()) {
      ...
      case 6:
        ...
        break;
      default:
        throw StateError('Unknown value $value');
    }
  ...
  Widget leftTitles(double value, TitleMeta meta) {
    ...
    return SideTitleWidget(
      angle: (value < 0 ? -45 : 45).degreesToRadians,
      axisSide: meta.axisSide,
      space: 4.0,
      child: Text(
        text,
          ...
          child: Padding(
            ...
            child: BarChart(
              BarChartData(
                ...
                barGroups: piecemealBarValues
                    .mapWithIdx(
                      (subValues, title) => generateGroup(
                        title,
                        subValues[0],
                        subValues[1],
                        subValues[2],
